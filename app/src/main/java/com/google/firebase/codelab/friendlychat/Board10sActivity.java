...
public class Board10sActivity extends AppCompatActivity {
    ...
    RecyclerView.LayoutManager mLayoutManager;//Item 항목배치
            ...
            public void run() {
                try {
                    ...
                    for(i = age*2; i<age*2+20; i++ ){
                        ...
                        //index 20~39는 10대의 실시간급상승 검색어 1위~20위, 40<=20대<60 , 60<=30대<80, 80<= 40대 <100, 100<=50대이상<120
                        //ArrayList에 순차적으로 추가.
                    }
